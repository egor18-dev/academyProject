...
@section('page')
   ...
   <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight">
       <div class="offcanvas-body">
           <button type="button" class="btn-close btn btn-sm btn-icon border"
           ...
           <div class="chat-user-details" id="chat-user-details">
               <div class="text-center mb-5">
                   ...
                   <p class="mb-1 fs-15 fw-medium text-dark lh-1 chatnameperson">Amelia Turner</p>
                   <p class="fs-13 text-muted"><span class="chatnameperson">emaileyjackson2134</span>@gmail.com</p>
                   <p class="text-center mb-0">
                       <button type="button" aria-label="button"
                           class="btn btn-icon rounded-pill btn-primary-light btn-wave"><i
                               class="ri-phone-line"></i></button>
                       <button type="button" aria-label="button"
                           class="btn btn-icon rounded-pill btn-secondary-light ms-2 btn-wave"><i
               ...
               <div class="mb-4">
                   <div class="fw-medium mb-4">Shared Files
                       ...
                       <span class="float-end fs-11"><a href="javascript:void(0);" class="fs-13 text-muted"> View
                               All<i class="ti ti-arrow-narrow-right ms-1"></i> </a></span>
                   </div>
                   <ul class="shared-files list-group list-unstyled">
                       <li class="list-group-item">
                           <div class="d-flex align-items-center">
                               ...
                               <div class="flex-fill">
                                   <p class="fs-14 fw-medium mb-0">Project Details.pdf</p>
                       ...
                       <li class="list-group-item">
                           <div class="d-flex align-items-center">
                               ...
                               <div class="flex-fill">
                                   <p class="fs-14 fw-medium mb-0">Img_02.Jpg</p>
                       ...
                       <li class="list-group-item">
                           <div class="d-flex align-items-center">
                               ...
                               <div class="flex-fill">
                                   <p class="fs-14 fw-medium mb-0">Img_15.Jpg</p>
                       ...
                       <li class="list-group-item">
                           <div class="d-flex align-items-center">
                               <div class="me-2 bg-info-transparent rounded">
                                   <span class="shared-file-icon">
                                       <i class="ri-video-line text-info"></i>
                                   </span>
                               </div>
                               <div class="flex-fill">
                                   <p class="fs-14 fw-medium mb-0">Video_15_02_2022.MP4</p>
                                   <p class="mb-0 text-muted fs-11">22,Oct 2024 - 10:18AM</p>
                               </div>
                               <div class="fs-18">
