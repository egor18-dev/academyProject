    ...
    <div class="main-sidebar w-100" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open w-100">
            ...
            <ul class="main-menu">
                ...
                <!-- Start::slide -->
                <li class="slide has-sub">
                    <a href="{{ route('users.index') }}" class="side-menu__item {{ Route::is('users.index') ? 'active' : '' }}">
                        <svg width="64px" height="64px" class="side-menu__icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
                ...
                <!-- Start::slide -->
                <li class="slide has-sub">
                    <a href="{{ route('classes.index') }}" class="side-menu__item {{ Route::is('classes.index') ? 'active' : '' }}">
                ...
                <!-- Start::slide -->
                <li class="slide has-sub">
                    <a href="{{route('levels.index')}}" class="side-menu__item {{ Route::is('levels.index') ? 'active' : '' }}">
                ...
                <!-- Start::slide -->
                <li class="slide has-sub">
                    <a href="{{ route('profile.index') }}" class="side-menu__item {{ Route::is('profile.index') ? 'active' : '' }}">
