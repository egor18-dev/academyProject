    ...
    <div class="main-sidebar w-100" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open w-100">
            ...
            <ul class="main-menu">
                ...
                <!-- Start::slide -->
                <li class="slide has-sub">
                    <a href="{{route('levels.index')}}" class="side-menu__item">
                        <svg fill="#fff" version="1.1" class="side-menu__icon" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" xml:space="preserve" stroke="#fff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <rect x="16" y="4" width="2" height="16"></rect> <rect x="11" y="10" width="2" height="10"></rect> <rect x="6" y="14" width="2" height="6"></rect> </g> </g></svg>
