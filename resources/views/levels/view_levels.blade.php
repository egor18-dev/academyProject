                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div>
                                                        ...
                                                        <span class="d-block text-muted fs-11" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" title="Last Contacted"><i class="ri-account-circle-line me-1 fs-13 align-middle"></i>{{$level->updated_at}}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>{{$level->description}}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="btn-list">
                                                    <a data-bs-toggle="offcanvas"
                                                    role="button" aria-controls="offcanvasExample" class="btn btn-sm btn-warning" href="{{ route('levels.show', ['uuid' => $level->uuid]) }}">
                                                    ...
                                                    <button class="btn btn-sm btn-danger removeBtn" onclick="removeUser('{{$level->uuid}}', '{{$level->name}}')">
